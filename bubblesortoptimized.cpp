/* bubble sort optimized - c++ version with STL std::vector as a vector of integers
...
void bubblesort()
{
    ...
    {
        iterations++;
        flag = 0;   //initialize after each pass to check if swapping happens or not in a particular pass
...
{   
    ...
    cout << "*** Bubble sort optimized version - c++ - ***" << endl;
